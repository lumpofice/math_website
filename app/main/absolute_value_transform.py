                ...
                if x_scalar != 1:
                    ...
                    if h != 0:
                        ...
                        if h < 0:
                            ...
                            np.absolute(x_scalar*(x_reflection*x-h)) + k
                            ax.plot(x, y_parent, label=r'$f(x)=\| x \|$')
                            ...
                            a_1 = h-1
                            b_1 = y_scalar*\
                            np.absolute(x_scalar*(x_reflection*a_1-h)) + k
                            ax.scatter(\
                            a_1, b_1,\
                            ...
                            a_2 = h+1
                            b_2 = y_scalar*\
                            np.absolute(x_scalar*(x_reflection*a_2-h)) + k
                            ax.scatter(\
                            a_2, b_2,\
                            ...
                            a_3 = h-2
                            b_3 = y_scalar*\
                            np.absolute(x_scalar*(x_reflection*a_3-h)) + k
                            ax.scatter(\
                            a_3, b_3,\
                        ...
                        y_parent = np.absolute(x)
                        y_transform = y_scalar*\
                        np.absolute(x_scalar*x_reflection*x) + k
                        ax.plot(x, y_parent, label=r'$f(x)=\| x \|$')
                        ax.plot(x, y_transform, label=r'$g(x)=a$'\
                        r'$\| bcx \| + k$')
                        ...
                        a_1 = 1
                        b_1 = y_scalar*\
                        np.absolute(x_scalar*x_reflection*a_1) + k
                        ax.scatter(\
                        a_1, b_1,\
                        label='({:f}, {:f})'.format(a_1, b_1),\
                        c='orange',\
                        ...
                        a_2 = -1
                        b_2 = y_scalar*\
                        np.absolute(x_scalar*x_reflection*a_2) + k
                        ax.scatter(\
                        a_2, b_2,\
                        label='({:f}, {:f})'.format(a_2, b_2),\
                        c='cyan',\
                        ...
                        a_3 = 2
                        b_3 = y_scalar*\
                        np.absolute(x_scalar*x_reflection*a_3) + k
                        ax.scatter(\
                        a_3, b_3,\
                        label='({:f}, {:f})'.format(a_3, b_3),\
                        c='purple',\
                    ...
                    x = np.linspace(-10, 10, 1000)
                    y_parent = np.absolute(x)
                    y_transform = y_scalar*np.absolute(x_reflection*x-h) + k
                    ax.plot(x, y_parent, label=r'$f(x)=\| x \|$')
                    ax.plot(x, y_transform, label=r'$g(x)=a$'\
                    r'$\| cx-h \| + k$')
                    ...
                    a_1 = -1
                    b_1 = y_scalar*\
                    np.absolute(x_reflection*a_1-h) + k
                    ax.scatter(\
                    a_1, b_1,\
                    label='({:f}, {:f})'.format(a_1, b_1),\
                    c='orange',\
                    ...
                    a_2 = 1
                    b_2 = y_scalar*\
                    np.absolute(x_reflection*a_2-h) + k
                    ax.scatter(\
                    a_2, b_2,\
                    label='({:f}, {:f})'.format(a_2, b_2),\
                    c='cyan',\
                    ...
                    a_3 = 2
                    b_3 = y_scalar*\
                    np.absolute(x_reflection*a_3-h) + k
                    ax.scatter(\
                    a_3, b_3,\
                    label='({:f}, {:f})'.format(a_3, b_3),\
                    c='purple',\
