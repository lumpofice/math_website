...
class ExponentialTransform():
    ...
    def general_exponential(self, base, h, x_scalar, x_reflection, y_scalar, k):
        """
                ...
                if x_scalar != 1:
                    ...
                    if h != 0:
                        ...
                        if h < 0:
                            ...
                            base**(x_scalar*(x_reflection*x-h)) + k
                            ax.plot(x, y_parent, label=r'$f(x)=B^{x}$')
                            ...
                            a_1 = h
                            b_1 = y_scalar*\
                            base**(x_scalar*(x_reflection*a_1-h)) + k
                            ax.scatter(\
                            a_1, b_1,\
                            ...
                            a_2 = h-0.5
                            b_2 = y_scalar*\
                            base**(x_scalar*(x_reflection*a_2-h)) + k
                            ax.scatter(\
                            a_2, b_2,\
                            ...
                            a_3 = h+0.5
                            b_3 = y_scalar*\
                            base**(x_scalar*(x_reflection*a_3-h)) + k
                            ax.scatter(\
                            a_3, b_3,\
                        ...
                        y_parent = base**x
                        y_transform = y_scalar*\
                        base**(x_scalar*x_reflection*x) + k
                        ax.plot(x, y_parent, label=r'$f(x)=B^{x}$')
                        ax.plot(x, y_transform, label=r'$g(x)=a$'\
                        r'$B^{bcx} + k$')
                        ...
                        a_1 = h
                        b_1 = y_scalar*\
                        base**(x_scalar*x_reflection*a_1) + k
                        ax.scatter(\
                        a_1, b_1,\
                        label='({:f}, {:f})'.format(a_1, b_1),\
                        c='orange',\
                        ...
                        a_2 = h-0.5
                        b_2 = y_scalar*\
                        base**(x_scalar*x_reflection*a_2) + k
                        ax.scatter(\
                        a_2, b_2,\
                        label='({:f}, {:f})'.format(a_2, b_2),\
                        c='cyan',\
                        ...
                        a_3 = h+0.5
                        b_3 = y_scalar*\
                        base**(x_scalar*x_reflection*a_3) + k
                        ax.scatter(\
                        a_3, b_3,\
                        label='({:f}, {:f})'.format(a_3, b_3),\
                        c='purple',\
    ...
    def base_e_exponential(self, h, x_scalar, x_reflection, y_scalar, k):
        """
        ORDER OF TRANSFORMATION:
        Let p be the parent function
        1) Let s_x(x) = bx. This is the x_scalar. Then p(s_x(x)) = p(bx). 
