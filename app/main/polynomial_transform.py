...
class PolynomialTransform():
    ...
    def polynomial_degree_1(self, h, y_scalar, k):
    ...
    def polynomial_degree_2(self, h, x_scalar, x_reflection, y_scalar, k):
        """
    ...
    def polynomial_degree_3(self, h, x_scalar, x_reflection, y_scalar, k):
        """
        ORDER OF TRANSFORMATION:
        Let p be the parent function
        1) Let s_x(x) = bx. This is the x_scalar. Then p(s_x(x)) = p(bx). 
