...
column in the User model. This "id" is created through the model in this script;
stored in the database to be retrieved as the user object for a given session
in the variable "current_user", the value of which is the "id".'''
...
as well as any posts corresponding to a registered user.'''
    ...
    class and stored in the application's database.'''
